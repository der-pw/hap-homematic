...
module.exports = class FFMPEG {
  ...
  prepareStream (request, callback) {
    ...
    let interfaces = Object.keys(os.networkInterfaces()).reduce((addresses, name) => {
      return addresses.concat(os.networkInterfaces()[name])
    }, [])
    let currentInterface = interfaces.find(details => !details.internal)
    let currentAddress = currentInterface ? currentInterface.address : '127.0.0.1'
    var addressResp = {
